...
object GraphCycles extends App {
  ...
  val fibonacciStaticGraph = GraphDSL.create() { implicit builder =>
    ...
    val merge1 = builder.add(MergePreferred[Int](1))
    val merge2 = builder.add(MergePreferred[Int](1))
    val inputBroadcast = builder.add(Broadcast[Int](2))
    val outputBroadcast = builder.add(Broadcast[Int](2))
    val adder = builder.add(ZipWith[Int, Int, Int](_ + _))
  ...
  val fibonacciGraph = RunnableGraph.fromGraph(
    GraphDSL.create() { implicit builder =>
      ...
      fibonacci.out ~> Sink.foreach[Int](println)
